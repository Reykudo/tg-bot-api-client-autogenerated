...
mkInlineQueryResultCachedVoice :: Data.Text.Internal.Text -- ^ 'id'
  -> Data.Text.Internal.Text -- ^ 'title'
  -> Data.Text.Internal.Text -- ^ 'type''
  -> Data.Text.Internal.Text -- ^ 'voiceFileId'
  -> InlineQueryResultCachedVoice
mkInlineQueryResultCachedVoice id title type' voiceFileId = InlineQueryResultCachedVoice{caption = GHC.Maybe.Nothing,
