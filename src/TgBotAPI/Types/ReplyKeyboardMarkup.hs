...
import  {-# SOURCE #-}  TgBotAPI.Types.KeyboardButton (KeyboardButton)
...
instance Data.Aeson.Types.ToJSON.ToJSON ReplyKeyboardMarkup
    where toJSON obj = Data.Aeson.Types.Internal.object ("keyboard" Data.Aeson.Types.ToJSON..= keyboard obj : "one_time_keyboard" Data.Aeson.Types.ToJSON..= oneTimeKeyboard obj : "resize_keyboard" Data.Aeson.Types.ToJSON..= resizeKeyboard obj : "selective" Data.Aeson.Types.ToJSON..= selective obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("keyboard" Data.Aeson.Types.ToJSON..= keyboard obj) GHC.Base.<> (("one_time_keyboard" Data.Aeson.Types.ToJSON..= oneTimeKeyboard obj) GHC.Base.<> (("resize_keyboard" Data.Aeson.Types.ToJSON..= resizeKeyboard obj) GHC.Base.<> ("selective" Data.Aeson.Types.ToJSON..= selective obj))))
...
mkReplyKeyboardMarkup :: [[KeyboardButton]] -- ^ 'keyboard'
  -> ReplyKeyboardMarkup
mkReplyKeyboardMarkup keyboard = ReplyKeyboardMarkup{keyboard = keyboard,
