...
instance Data.Aeson.Types.ToJSON.ToJSON ReplyKeyboardRemove
    where toJSON obj = Data.Aeson.Types.Internal.object ("remove_keyboard" Data.Aeson.Types.ToJSON..= removeKeyboard obj : "selective" Data.Aeson.Types.ToJSON..= selective obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("remove_keyboard" Data.Aeson.Types.ToJSON..= removeKeyboard obj) GHC.Base.<> ("selective" Data.Aeson.Types.ToJSON..= selective obj))
...
mkReplyKeyboardRemove :: GHC.Types.Bool -- ^ 'removeKeyboard'
  -> ReplyKeyboardRemove
mkReplyKeyboardRemove removeKeyboard = ReplyKeyboardRemove{removeKeyboard = removeKeyboard,
