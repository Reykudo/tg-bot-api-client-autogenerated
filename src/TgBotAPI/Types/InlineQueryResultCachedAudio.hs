...
instance Data.Aeson.Types.ToJSON.ToJSON InlineQueryResultCachedAudio
    where toJSON obj = Data.Aeson.Types.Internal.object ("audio_file_id" Data.Aeson.Types.ToJSON..= audioFileId obj : "caption" Data.Aeson.Types.ToJSON..= caption obj : "caption_entities" Data.Aeson.Types.ToJSON..= captionEntities obj : "id" Data.Aeson.Types.ToJSON..= id obj : "input_message_content" Data.Aeson.Types.ToJSON..= inputMessageContent obj : "parse_mode" Data.Aeson.Types.ToJSON..= parseMode obj : "reply_markup" Data.Aeson.Types.ToJSON..= replyMarkup obj : "type" Data.Aeson.Types.ToJSON..= type' obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("audio_file_id" Data.Aeson.Types.ToJSON..= audioFileId obj) GHC.Base.<> (("caption" Data.Aeson.Types.ToJSON..= caption obj) GHC.Base.<> (("caption_entities" Data.Aeson.Types.ToJSON..= captionEntities obj) GHC.Base.<> (("id" Data.Aeson.Types.ToJSON..= id obj) GHC.Base.<> (("input_message_content" Data.Aeson.Types.ToJSON..= inputMessageContent obj) GHC.Base.<> (("parse_mode" Data.Aeson.Types.ToJSON..= parseMode obj) GHC.Base.<> (("reply_markup" Data.Aeson.Types.ToJSON..= replyMarkup obj) GHC.Base.<> ("type" Data.Aeson.Types.ToJSON..= type' obj))))))))
...
mkInlineQueryResultCachedAudio :: Data.Text.Internal.Text -- ^ 'audioFileId'
  -> Data.Text.Internal.Text -- ^ 'id'
  -> Data.Text.Internal.Text -- ^ 'type''
  -> InlineQueryResultCachedAudio
mkInlineQueryResultCachedAudio audioFileId id type' = InlineQueryResultCachedAudio{audioFileId = audioFileId,
