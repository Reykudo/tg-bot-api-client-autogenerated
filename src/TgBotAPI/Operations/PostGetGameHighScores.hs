...
-- | Defines the object schema located at @paths.\/getGameHighScores.POST.responses.200.content.application\/json.schema@ in the specification.
-- 
-- 
...
postGetGameHighScoresWithConfiguration :: forall m . TgBotAPI.Common.MonadHTTP m => TgBotAPI.Common.Configuration -- ^ The configuration to use in the request
...
-- | > POST /getGameHighScores
-- 
-- The same as 'postGetGameHighScores' but returns the raw 'Data.ByteString.Char8.ByteString'.
postGetGameHighScoresRaw :: forall m . TgBotAPI.Common.MonadHTTP m => PostGetGameHighScoresRequestBody -- ^ The request body to send
  -> TgBotAPI.Common.StripeT m (Network.HTTP.Client.Types.Response Data.ByteString.Internal.ByteString) -- ^ Monadic computation which returns the result of the operation
postGetGameHighScoresRaw body = GHC.Base.id (TgBotAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/getGameHighScores") GHC.Base.mempty (GHC.Maybe.Just body) TgBotAPI.Common.RequestBodyEncodingJSON)
-- | > POST /getGameHighScores
-- 
-- The same as 'postGetGameHighScores' but accepts an explicit configuration and returns the raw 'Data.ByteString.Char8.ByteString'.
postGetGameHighScoresWithConfigurationRaw :: forall m . TgBotAPI.Common.MonadHTTP m => TgBotAPI.Common.Configuration -- ^ The configuration to use in the request
  -> PostGetGameHighScoresRequestBody -- ^ The request body to send
  -> m (Network.HTTP.Client.Types.Response Data.ByteString.Internal.ByteString) -- ^ Monadic computation which returns the result of the operation
postGetGameHighScoresWithConfigurationRaw config
                                          body = GHC.Base.id (TgBotAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/getGameHighScores") GHC.Base.mempty (GHC.Maybe.Just body) TgBotAPI.Common.RequestBodyEncodingJSON)
