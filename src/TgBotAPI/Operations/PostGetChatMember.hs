...
postGetChatMember body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostGetChatMemberResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostGetChatMemberResponse200 Data.Functor.<$> ((Data.Bifunctor.first Data.Text.pack (Data.Aeson.eitherDecodeStrict body)) :: Data.Either.Either Data.Text.Text
                                                                                                                                                                     ...
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostGetChatMemberResponseDefault Data.Functor.<$> ((Data.Bifunctor.first Data.Text.pack (Data.Aeson.eitherDecodeStrict body)) :: Data.Either.Either Data.Text.Text
                                                                                                                                                                                                                                                                                                                                                                        Error)
...
data PostGetChatMemberRequestBody = PostGetChatMemberRequestBody {
  ...
  postGetChatMemberRequestBodyChatId :: PostGetChatMemberRequestBodyChatIdVariants
...
mkPostGetChatMemberRequestBody :: PostGetChatMemberRequestBodyChatIdVariants -- ^ 'postGetChatMemberRequestBodyChatId'
...
data PostGetChatMemberRequestBodyChatIdVariants =
   PostGetChatMemberRequestBodyChatIdInt GHC.Types.Int
  | PostGetChatMemberRequestBodyChatIdText Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostGetChatMemberRequestBodyChatIdVariants
    where toJSON (PostGetChatMemberRequestBodyChatIdInt a) = Data.Aeson.Types.ToJSON.toJSON a
          toJSON (PostGetChatMemberRequestBodyChatIdText a) = Data.Aeson.Types.ToJSON.toJSON a
instance Data.Aeson.Types.FromJSON.FromJSON PostGetChatMemberRequestBodyChatIdVariants
    where parseJSON val = case (PostGetChatMemberRequestBodyChatIdInt Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostGetChatMemberRequestBodyChatIdText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PostGetChatMemberResponse =
   PostGetChatMemberResponseError Data.Text.Text -- ^ Means either no matching case available or a parse error
