...
mkPostUnpinAllChatMessagesRequestBody :: ChatIdVariants -- ^ 'chatId'
  -> PostUnpinAllChatMessagesRequestBody
mkPostUnpinAllChatMessagesRequestBody chatId = PostUnpinAllChatMessagesRequestBody{chatId = chatId}
...
mkPostUnpinAllChatMessagesResponseBody200 :: GHC.Types.Bool -- ^ 'ok'
  -> GHC.Types.Bool -- ^ 'result'
  -> PostUnpinAllChatMessagesResponseBody200
mkPostUnpinAllChatMessagesResponseBody200 ok result = PostUnpinAllChatMessagesResponseBody200{ok = ok,
                                                                                              result = result}
-- | > POST /unpinAllChatMessages
-- 
