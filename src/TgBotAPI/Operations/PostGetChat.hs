...
postGetChat ::
  ...
  TgBotAPI.Common.StripeT m (Network.HTTP.Client.Types.Response PostGetChatResponse)
postGetChat body =
  GHC.Base.fmap
    ( \response_0 ->
        GHC.Base.fmap
          ( Data.Either.either PostGetChatResponseError GHC.Base.id
              GHC.Base.. ( \response body ->
                             if
                                 | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) ->
                                   PostGetChatResponse200
    ...
    (TgBotAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/getChat") GHC.Base.mempty (GHC.Maybe.Just body) TgBotAPI.Common.RequestBodyEncodingJSON)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostGetChatRequestBody where
  toJSON obj = Data.Aeson.Types.Internal.object ("chat_id" Data.Aeson.Types.ToJSON..= chatId obj : GHC.Base.mempty)
  toEncoding obj = Data.Aeson.Encoding.Internal.pairs ("chat_id" Data.Aeson.Types.ToJSON..= chatId obj)

instance Data.Aeson.Types.FromJSON.FromJSON PostGetChatRequestBody where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostGetChatRequestBody" (\obj -> GHC.Base.pure PostGetChatRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "chat_id"))

-- | Create a new 'PostGetChatRequestBody' with all required fields.
mkPostGetChatRequestBody ::
  -- | 'chatId'
  ChatIdVariants ->
  PostGetChatRequestBody
...
data PostGetChatResponse
  = -- | Means either no matching case available or a parse error
    PostGetChatResponseError GHC.Base.String
  | -- |
...
instance Data.Aeson.Types.ToJSON.ToJSON PostGetChatResponseBody200 where
...
instance Data.Aeson.Types.FromJSON.FromJSON PostGetChatResponseBody200 where
  parseJSON = Data.Aeson.Types.FromJSON.withObject "PostGetChatResponseBody200" (\obj -> (GHC.Base.pure PostGetChatResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "ok")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "result"))

-- | Create a new 'PostGetChatResponseBody200' with all required fields.
mkPostGetChatResponseBody200 ::
  -- | 'ok'
  GHC.Types.Bool ->
  -- | 'result'
  Chat ->
  PostGetChatResponseBody200
mkPostGetChatResponseBody200 ok result =
  PostGetChatResponseBody200
    { ok = ok,
      result = result
    }
...
postGetChatWithConfiguration ::
  ...
  PostGetChatRequestBody ->
  -- | Monadic computation which returns the result of the operation
  m (Network.HTTP.Client.Types.Response PostGetChatResponse)
postGetChatWithConfiguration
  config
  body =
    GHC.Base.fmap
      ...
      (TgBotAPI.Common.doBodyCallWithConfiguration config (Data.Text.toUpper GHC.Base.$ Data.Text.pack "POST") (Data.Text.pack "/getChat") GHC.Base.mempty (GHC.Maybe.Just body) TgBotAPI.Common.RequestBodyEncodingJSON)
...
postGetChatWithConfigurationRaw ::
  forall m.
  TgBotAPI.Common.MonadHTTP m =>
  -- | The configuration to use in the request
  TgBotAPI.Common.Configuration ->
