...
postGetUpdates body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostGetUpdatesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostGetUpdatesResponse200 Data.Functor.<$> ((Data.Bifunctor.first Data.Text.pack (Data.Aeson.eitherDecodeStrict body)) :: Data.Either.Either Data.Text.Text
                                                                                                                                                               ...
                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostGetUpdatesResponseDefault Data.Functor.<$> ((Data.Bifunctor.first Data.Text.pack (Data.Aeson.eitherDecodeStrict body)) :: Data.Either.Either Data.Text.Text
                                                                                                                                                                                                                                                                                                                                                               Error)
...
data PostGetUpdatesRequestBody = PostGetUpdatesRequestBody {
  ...
  postGetUpdatesRequestBodyAllowedUpdates :: (GHC.Maybe.Maybe ([Data.Text.Internal.Text]))
  ...
  -- * Maxium  of 100.0
  -- * Minimum  of 1.0
  , postGetUpdatesRequestBodyLimit :: (GHC.Maybe.Maybe GHC.Types.Int)
  ...
  , postGetUpdatesRequestBodyOffset :: (GHC.Maybe.Maybe GHC.Types.Int)
  ...
  , postGetUpdatesRequestBodyTimeout :: (GHC.Maybe.Maybe GHC.Types.Int)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostGetUpdatesRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object ("allowed_updates" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyAllowedUpdates obj : "limit" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyLimit obj : "offset" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyOffset obj : "timeout" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyTimeout obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("allowed_updates" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyAllowedUpdates obj) GHC.Base.<> (("limit" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyLimit obj) GHC.Base.<> (("offset" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyOffset obj) GHC.Base.<> ("timeout" Data.Aeson.Types.ToJSON..= postGetUpdatesRequestBodyTimeout obj))))
...
mkPostGetUpdatesRequestBody = PostGetUpdatesRequestBody{postGetUpdatesRequestBodyAllowedUpdates = GHC.Maybe.Nothing,
                                                        postGetUpdatesRequestBodyLimit = GHC.Maybe.Nothing,
                                                        postGetUpdatesRequestBodyOffset = GHC.Maybe.Nothing,
                                                        postGetUpdatesRequestBodyTimeout = GHC.Maybe.Nothing}
...
data PostGetUpdatesResponse =
   PostGetUpdatesResponseError Data.Text.Text -- ^ Means either no matching case available or a parse error
...
data PostGetUpdatesResponseBody200 = PostGetUpdatesResponseBody200 {
  -- | ok
  postGetUpdatesResponseBody200Ok :: GHC.Types.Bool
  -- | result
  , postGetUpdatesResponseBody200Result :: ([Update])
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostGetUpdatesResponseBody200
    where toJSON obj = Data.Aeson.Types.Internal.object ("ok" Data.Aeson.Types.ToJSON..= postGetUpdatesResponseBody200Ok obj : "result" Data.Aeson.Types.ToJSON..= postGetUpdatesResponseBody200Result obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("ok" Data.Aeson.Types.ToJSON..= postGetUpdatesResponseBody200Ok obj) GHC.Base.<> ("result" Data.Aeson.Types.ToJSON..= postGetUpdatesResponseBody200Result obj))
...
mkPostGetUpdatesResponseBody200 :: GHC.Types.Bool -- ^ 'postGetUpdatesResponseBody200Ok'
  -> [Update] -- ^ 'postGetUpdatesResponseBody200Result'
  -> PostGetUpdatesResponseBody200
mkPostGetUpdatesResponseBody200 postGetUpdatesResponseBody200Ok postGetUpdatesResponseBody200Result = PostGetUpdatesResponseBody200{postGetUpdatesResponseBody200Ok = postGetUpdatesResponseBody200Ok,
                                                                                                                                    postGetUpdatesResponseBody200Result = postGetUpdatesResponseBody200Result}
-- | > POST /getUpdates
-- 
