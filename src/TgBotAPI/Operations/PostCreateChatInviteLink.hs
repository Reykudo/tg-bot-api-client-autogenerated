...
instance Data.Aeson.Types.ToJSON.ToJSON PostCreateChatInviteLinkRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object ("chat_id" Data.Aeson.Types.ToJSON..= chatId obj : "expire_date" Data.Aeson.Types.ToJSON..= expireDate obj : "member_limit" Data.Aeson.Types.ToJSON..= memberLimit obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("chat_id" Data.Aeson.Types.ToJSON..= chatId obj) GHC.Base.<> (("expire_date" Data.Aeson.Types.ToJSON..= expireDate obj) GHC.Base.<> ("member_limit" Data.Aeson.Types.ToJSON..= memberLimit obj)))
...
mkPostCreateChatInviteLinkRequestBody :: ChatIdVariants -- ^ 'chatId'
  -> PostCreateChatInviteLinkRequestBody
mkPostCreateChatInviteLinkRequestBody chatId = PostCreateChatInviteLinkRequestBody{chatId = chatId,
...
mkPostCreateChatInviteLinkResponseBody200 :: GHC.Types.Bool -- ^ 'ok'
  -> ChatInviteLink -- ^ 'result'
  -> PostCreateChatInviteLinkResponseBody200
mkPostCreateChatInviteLinkResponseBody200 ok result = PostCreateChatInviteLinkResponseBody200{ok = ok,
                                                                                              result = result}
-- | > POST /createChatInviteLink
-- 
