...
mkPostDeleteChatStickerSetRequestBody :: ChatIdVariants -- ^ 'chatId'
  -> PostDeleteChatStickerSetRequestBody
mkPostDeleteChatStickerSetRequestBody chatId = PostDeleteChatStickerSetRequestBody{chatId = chatId}
...
mkPostDeleteChatStickerSetResponseBody200 :: GHC.Types.Bool -- ^ 'ok'
  -> GHC.Types.Bool -- ^ 'result'
  -> PostDeleteChatStickerSetResponseBody200
mkPostDeleteChatStickerSetResponseBody200 ok result = PostDeleteChatStickerSetResponseBody200{ok = ok,
                                                                                              result = result}
-- | > POST /deleteChatStickerSet
-- 
