...
postSetChatDescription body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSetChatDescriptionResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatDescriptionResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                     PostSetChatDescriptionResponseBody200)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatDescriptionResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                       Error)
...
instance Data.Aeson.Types.ToJSON.ToJSON PostSetChatDescriptionRequestBody
    where toJSON obj = Data.Aeson.Types.Internal.object ("chat_id" Data.Aeson.Types.ToJSON..= chatId obj : "description" Data.Aeson.Types.ToJSON..= description obj : GHC.Base.mempty)
          toEncoding obj = Data.Aeson.Encoding.Internal.pairs (("chat_id" Data.Aeson.Types.ToJSON..= chatId obj) GHC.Base.<> ("description" Data.Aeson.Types.ToJSON..= description obj))
...
mkPostSetChatDescriptionRequestBody :: ChatIdVariants -- ^ 'chatId'
  -> PostSetChatDescriptionRequestBody
mkPostSetChatDescriptionRequestBody chatId = PostSetChatDescriptionRequestBody{chatId = chatId,
...
data PostSetChatDescriptionResponse =
   PostSetChatDescriptionResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
...
mkPostSetChatDescriptionResponseBody200 :: GHC.Types.Bool -- ^ 'ok'
  -> GHC.Types.Bool -- ^ 'result'
  -> PostSetChatDescriptionResponseBody200
mkPostSetChatDescriptionResponseBody200 ok result = PostSetChatDescriptionResponseBody200{ok = ok,
                                                                                          result = result}
-- | > POST /setChatDescription
-- 
...
postSetChatDescriptionWithConfiguration config
                                        body = GHC.Base.fmap (\response_2 -> GHC.Base.fmap (Data.Either.either PostSetChatDescriptionResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_3 -> Network.HTTP.Types.Status.statusCode status_3 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatDescriptionResponse200 Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                      PostSetChatDescriptionResponseBody200)
                                                                                                                                                                                                | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetChatDescriptionResponseDefault Data.Functor.<$> (Data.Aeson.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                        Error)
